            ...
            <div class="jobon-container">
                ...
                <div class="mypage-layout">
                    ...
                    <section class="card card--padded">
                        <div class="toolbar"><select class="form-control" style="max-width:170px">
                                <option>전체 활동</option>
                                <option>기업</option>
                                <option>채용공고</option>
                                <option>TODO</option>
                        ...
                        <div class="preview-list">
                            <div class="preview-row"><span>채용공고 · 네이버 백엔드 개발자 공고 등록</span><b>2시간 전</b></div>
                            <div class="preview-row"><span>TODO · 자기소개서 수정 등록</span><b>어제</b></div>
                            <div class="preview-row"><span>성장 기록 · Spring Boot 복습 작성</span><b>2일 전</b></div>
                        </div>
                    </section>
                </div>
            </div>
