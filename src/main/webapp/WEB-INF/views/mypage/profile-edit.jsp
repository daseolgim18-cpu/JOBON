...
<main class="jobon-page">
  <div class="jobon-container mypage-container">
    ...
    <form class="card card--padded profile-edit-card"
          action="${ctx}/mypage/profile/edit"
          method="post"
      ...
      <div class="profile-edit-top">
        <section class="profile-image-section">
          ...
          <input class="profile-image-input"
                 id="profileImage"
                 name="profileImage"
                 type="file"
        ...
        <section class="profile-basic-section">
          ...
          <div class="form-group">
            ...
            <div class="profile-nickname-row">
              ...
              <input class="form-control profile-form-control"
                     id="nickname"
                     name="nickname"
                     type="text"
                     maxlength="50"
                     value="${fn:escapeXml(member.nickname)}"
                     data-original-nickname="${fn:escapeXml(member.nickname)}"
                     placeholder="닉네임을 입력하세요"
                     required/>

              <button class="profile-nickname-check-btn"
                      id="nicknameCheckBtn"
                      type="button">
                중복 확인
              </button>
            ...
            <p class="profile-nickname-message"
        ...
        <div class="form-grid profile-edit-grid">
          <div class="form-group form-group--full">
            ...
            <input class="form-control profile-form-control"
                   ...
                   type="text"
                   maxlength="300"
                   value="${fn:escapeXml(member.introduction)}"
                   placeholder="나를 간단하게 소개해 주세요."/>
          </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control profile-form-control"
                   ...
                   type="text"
                   maxlength="100"
                   value="${fn:escapeXml(member.interestJob)}"
          ...
          <div class="form-group">
            ...
            <input class="form-control profile-form-control"
                   ...
                   type="text"
                   maxlength="100"
                   value="${fn:escapeXml(member.preferredLocation)}"
                   placeholder="예: 서울 / 경기"/>
          </div>
        </div>
      </section>
